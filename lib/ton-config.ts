...
export const TON_CENTER_API_KEY =
  process.env.TON_CENTER_API_KEY || "88c5d1b06d51f91dd4548ded80f45c402d190746965cce3c1bf2f4a8c579523a"

export const JETTON_MASTER_ADDRESS =
  process.env.JETTON_MASTER_ADDRESS || "EQA4-TXXumNx_om3IlqSUaXVHrveaCm-sVpp3r7S0SnCfLB2"

export const TELEGRAM_BOT_TOKEN = process.env.TELEGRAM_BOT_TOKEN || "7367415110:AAE_eLMMgvM9rERzsHlbYoxlm2apsiVsrHU"
